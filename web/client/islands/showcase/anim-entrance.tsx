...
import { AddIcon, CloseIcon, iconButtonStyle } from "./_lib/icons.tsx";
...
export const EntranceExitDemo = clientEntry(
  `${import.meta.url}#EntranceExitDemo`,
                ...
                {items.map((item) => (
                  <li
                    ...
                    mix={[
                      ...
                      animateExit({
                        ...config,
                        duration: Math.min(config.duration, 200),
                      }),
                      css({
                        display: "flex",
                        alignItems: "center",
