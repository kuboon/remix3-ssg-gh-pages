 ...
 *   reconciliation of the DOM — measurably so: one click on a chip in the UI showcase pulled the
 *   document again and re-hydrated eighteen islands to do what the browser does for free.
